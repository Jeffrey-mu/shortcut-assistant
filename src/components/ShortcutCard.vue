      ...
      <div :class="[workMode ? 'mb-0 flex-col items-center justify-center gap-0' : 'mb-3 items-start flex-row justify-between', 'flex h-full w-full']">
        ...
        <div v-if="!workMode" class="flex items-center gap-1.5 shrink-0">
          <button 
            ...
            class="p-2.5 rounded-xl transition-all duration-300 hover:scale-110 hover:-translate-y-0.5 active:scale-95 shadow-sm hover:shadow-md"
            :class="store.settings.transparentWindow ? 'bg-transparent' : 'bg-white/50 dark:bg-transparent'"
            :style="{ 
          ...
          <div class="relative" ref="menuRef">
            <button 
              ...
              class="p-2.5 text-slate-400 transition-all duration-200 rounded-xl active:scale-95"
              :class="[
            ...
            <div 
              ...
              :class="store.settings.transparentWindow ? 'bg-white/80 dark:bg-slate-800/80 border-slate-200/50 dark:border-slate-700/30' : 'bg-white/95 dark:bg-slate-800/95 border-slate-200 dark:border-slate-700/50'"
            >
              <button 
